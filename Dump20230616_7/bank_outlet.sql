...
CREATE TABLE `outlet` (
  ...
  `outlet_name` varchar(20) DEFAULT NULL,
...
INSERT INTO `outlet` VALUES (4,'KB국민은행'),(5,'하나은행'),(10,'농협은행'),(20,'우리은행'),(21,'신한은행'),(23,'SC제일은행'),(31,'대구은행'),(32,'부산은행'),(34,'광주은행'),(45,'새마을금고'),(71,'우체국예금'),(90,'카카오뱅크'),(92,'토스뱅크');
